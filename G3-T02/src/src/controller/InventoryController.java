...
public class InventoryController {
     ...
     * store.
     *
     * @return null if data cannot be loaded,
	 * otherwise a list of seeds'
     ...
     *
     * @return null if data cannot be loaded,
	 * otherwise a list of seed's name in the store.
     */
     ...
     * @param f An Farmer object that is currently logging on.
     * @return The message with reason if the input is invalid or farmer's gold is
     ...
     * @throws exception.FarmCityControlException  Throw exception when user send request to oneself
     * @throws java.io.IOException Throw exception when there is no plots.csv or inventory.csv
     * @return THe message with reason if the user cannot send the gift; successful
