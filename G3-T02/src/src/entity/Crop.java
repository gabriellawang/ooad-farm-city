...
public class Crop {
	 ...
	 *
     * @return The cost of one bag of seed of the crop.
     */
    public int getCost() {
        return cost;
    }
     ...
     *
     * @return The xp earned for one unit of crop produced.
     */
    public int getXP() {
        return XP;
    }
	 ...
	 *
     * @return The minimum yield (in units).
     */
     ...
     *
     * @return The maximum yield (in units).
     */
     ...
     *
     * @return The price of one unit of produce the farmer gains.
     */
    public int getPrice() {
        return price;
    }
