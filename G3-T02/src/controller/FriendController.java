...
public class FriendController {
     ...
     * @return fList An ArrayList of friends(Farmer) user
     */
	 ...
	 *
     * @param f The Farmer object of user
     * @return rList an ArrayList of friend request user
     */
    ...
    public void sendRequest(Farmer f, String username) throws FarmCityControlException, IOException {
        ...
        if (anotherF == null) { // Check whether the user exists.
            throw new FarmCityControlException("Username doesn't exist. Please try again.");
        } else {
     ...
     * @return result The boolean result if the friend is successfully removed
     * @throws IOException Throw exception when there is no friends.csv
     */
