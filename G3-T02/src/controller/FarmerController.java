...
public class FarmerController {
     ...
     * @return rankName The name of the user current ranking
     */
	 ...
	 *
     * @param f The Farmer object of user
     * @return amt The amount of plot user has
     */
	 ...
	 *
     * @param f The Farmer object of user
     * @return display The ArrayList of the display of plots of the user 
     */
