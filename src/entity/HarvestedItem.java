...
public class HarvestedItem{
	 ...
	 *
     * @return cropName The name of the crop that is harvested.
     */
	 ...
	 *
     * @return unit The unit of crop harvested.
     */
    public int getUnit() {
		return unit;
	}
	 ...
	 *
     * @return XP The amount of experience the farmer earn from harvesting the crop.
     */
    public int getXP(){
		return XP;
	}
	 ...
	 *
     * @return gold The amount of gold the farmer earn from harvesting the crop.
     */
    public int getGold(){
		return gold;
	}
	 ...
	 *
     * @param u The number of unit added.
     */
	 ...
	 *
     * @param xp The amount of experience added
     */
	 ...
	 *
     * @param g The amount of gold added.
     */
